...
class Parser():
    ...
    def get_voucher_codes_cards(self):
        ...
        list_cards = [i.get_attribute('outerHTML') for i in
                      self.driver.find_elements(By.XPATH, '//article[contains(@class, "voucher")]')]
    ...
    def get_deals_page(self):
        ...
        list_image = ' '.join(
            self.finds('//div[contains(@class,  "thread--deal")]//img', method='get_attribute', method_arguments='src'))
        # $x('//h1')
        ...
        vote = self.find(
            '//div[contains(@id,"thread")]//span[contains(@class,  "cept-vote-temp vote-temp vote-temp--burn")]',
            'innerHTML')
        ...
        date_update = self.find('//div[contains(@class,"cept-thread-content")]//div[contains(@class,  "threadUpdate")]',
                                'text')
        # # $x('//div[contains(@class,"cept-thread-content")]//div[contains(@class,  "content ")]').map(i=>i.textContent)
        content = ' '.join(
            self.finds('//div[contains(@class,"cept-thread-content")]//div[contains(@class,  "content ")]', 'text'))
        data = {
    ...
    def get_voucher_codes_page(self):
        ...
        list_image = ' '.join(self.finds('//div[contains(@class, "cept-thread-content")]//img', method='get_attribute',
                                         method_arguments='src'))
        # # $x('//h1')
