...
sidebar = driver.find_elements(By.XPATH, '//div[contains(@id, "scrollWrapper")]//button')
...
for button_sidebar in sidebar:
    ...
    category_temp = driver.find_elements(By.XPATH, '//section//h2').text
...
pd.DataFrame(data).to_excel(f'costa_url_foods_{str(date)}.xlsx')